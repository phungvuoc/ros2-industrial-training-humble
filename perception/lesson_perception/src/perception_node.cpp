...
class PerceptionNode : public rclcpp::Node
{
    ...
    private:
        ...
        void cloud_callback(const sensor_msgs::msg::PointCloud2::ConstSharedPtr recent_cloud)
        {
            ...
            {
                RCLCPP_WARN_STREAM(this->get_logger(), "\033[1;31m" << "Could not estimate a planar model for the given dataset." << "\033[0m");
            }
            ...
            RCLCPP_INFO_STREAM(this->get_logger(), 
                "PointCloud2 representing the planar component: " << cloud_plane->points.size() << " data points.");
            ...
            *cloud_filtered = *cloud_f;
            ...
            ec.extract(cluster_indices); // Each point will be labeled between 0 to number of clusters (cluster_indices)

            std::vector<sensor_msgs::msg::PointCloud2::SharedPtr> pc2_clusters;
            std::vector<pcl::PointCloud<pcl::PointXYZ>::Ptr> clusters;

            int j = 0; // to count the number of clusters
            for (const auto& cluster : cluster_indices)
            {
                ...
                //RCLCPP_INFO(this->get_logger(), "Cluster '%d' has '%lu' points", j, cloud_cluster->points.size());
            ...
            sor.setStddevMulThresh(1.0); // sigma
            ...
            pcl::transformPointCloud(*pick_surface_cloud_ptr, *pick_surface_cloud_ptr, Eigen::Affine3d(eigen3d));
            ...
            this->publishPointCloud(cropbox_publisher_, xyz_filtered_cloud);
            this->publishPointCloud(plane_publisher_, *cloud_f);
            this->publishPointCloud(euclidean_publisher_, *(clusters.at(2)));
            this->publishPointCloud(stat_publisher_, *sor_cloud_filtered);
            this->publishPointCloud(polygon_publisher_, *prism_filtered_cloud_ptr);
        }
